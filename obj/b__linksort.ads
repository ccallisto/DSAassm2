...
package ada_main is
   ...
   GNAT_Version : constant String :=
                    "GNAT Version: 13.2.1 20240316 (Red Hat 13.2.1-7)" & ASCII.NUL;
   pragma Export (C, GNAT_Version, "__gnat_version");

   GNAT_Version_Address : constant System.Address := GNAT_Version'Address;
   pragma Export (C, GNAT_Version_Address, "__gnat_version_address");

   Ada_Main_Program_Name : constant String := "_ada_linksort" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#81db0c84#;
   ...
   u00133 : constant Version_32 := 16#b9e97595#;
   pragma Export (C, u00133, "ada__text_io__enumeration_auxB");
   u00134 : constant Version_32 := 16#36b07428#;
   ...
   u00149 : constant Version_32 := 16#92946bcf#;
   pragma Export (C, u00149, "system__val_enum_8S");
   u00150 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00150, "system__memoryB");
   u00151 : constant Version_32 := 16#19e99d68#;
